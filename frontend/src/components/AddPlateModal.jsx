...
export default function AddPlateModal({ onSubmit, modalId = "addPlateModal" }) {
    ...
    return (
        <Modal
            ...
            confirmFunction={() => { document.getElementById(modalId + "-formSubmitButton").click() }}
            showButtons={true}
        >
            <div className="modal-body">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button hidden={true} type="submit" id={modalId + "-formSubmitButton"}></button>
                </form>
            </div>
        </Modal>
    )
